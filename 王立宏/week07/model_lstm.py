...
class LSTMClassifier:
    def __init__(self, config, vocab_size):
        ...
        self.model = LSTMModel(
            ...
            embedding_dim=config.textcnn_embedding_dim,  # 使用TextCNN的embedding_dim
        ...
        # 优化器和损失函数
        self.optimizer = optim.Adam(self.model.parameters(), lr=config.lstm_lr)
    ...
    def train(self, train_dataloader):
        ...
        for epoch in range(self.config.lstm_epochs):
            ...
            print(f'LSTM Epoch {epoch+1}/{self.config.lstm_epochs}, Loss: {avg_loss:.4f}')
